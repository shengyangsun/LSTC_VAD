            ...
            if auc_train > best_train_auc:
                ...
                if auc_train > args.save_threshold:
                    ...
                    torch.save(temporal_model.state_dict(),
                               args.model_save_dir + args.saved_prefix + "temporal_model_oneCrop_" + args.type + "_" + str(
                                   auc_train))
                    torch.save(classifier_model.state_dict(),
                               args.model_save_dir + args.saved_prefix + "classifier_model_oneCrop_" + args.type + "_" + str(
                                   auc_train))
...
def parser_arg():
    ...
    parser.add_argument('--load_temporal_model_path', type=str, default='temporal')
    parser.add_argument('--load_classifier_model_path', type=str, default='classifier')
    ...
    parser.add_argument('--saved_prefix', type=str, default=None)
