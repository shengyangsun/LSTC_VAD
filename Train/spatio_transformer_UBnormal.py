...
def train(args):
    ...
    spatio_model = Encoder(n_layers=args.n_layers, n_head=args.n_head, d_k=args.d_k, d_v=args.d_v,
                           ...
                           relative_pe_2D=args.relative_pe_2D)
        ...
        if epoch % args.inter_epoch == 0:
            ...
            if auc_train > best_train_auc:
                ...
                if auc_train > args.save_threshold:
                    ...
                    torch.save(spatio_model.state_dict(), os.path.join(args.model_save_dir, "spatio_model_oneCrop_" +
                                                                       args.type + "_" + str(auc_train)))
                    torch.save(regression_model.state_dict(),
                               os.path.join(args.model_save_dir, "regression_model_oneCrop_" +
                                            args.type + "_" + str(auc_train)))
...
def parser_arg():
    ...
    parser.add_argument('--dataset_path', type=str, default="/ssd/ssy/UBnormal/UBnormal_I3D_16PATCH.h5")
    parser.add_argument('--model_save_dir', type=str, default="/data/ssy/code/VAD_ST/data/UBnormal/model_save")
    parser.add_argument('--version', type=str, default="1.0")
    parser.add_argument('--training_txt',type=str,default='/data/ssy/code/VAD_ST/data/UBnormal/train_video_names_frames.txt')
    parser.add_argument('--testing_txt',type=str,default='/data/ssy/code/VAD_ST/data/UBnormal/test_video_names_frames.txt')
    parser.add_argument('--test_mask_dir',type=str,default='/data/ssy/code/VAD_ST/data/UBnormal/test_frame_mask')
